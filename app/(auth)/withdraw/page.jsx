    ...
    const postHandle = ()=>{
          if(bankName === ""){
            ...
            formData.append("des", holderName);
               ...
               axios.post('https://isda-farm.onrender.com/transaction', formData, {
                headers: {
...
<div style={{display:modalHandle}} className="absolute bg-[#7e0beb69] z-50 top-0 left-0 w-full h-screen flex justify-center items-center">
        ...
        <div className="bg-gradient-to-t from-[#0fe8e4]  to-[#06253e] overflow-hidden h-screen  relative ">
   ...
   <div className="w-[350px] justify-center items-center my-4 mx-2 card_gradient rounded-xl">
