...
const Login =()=>{
 ...
 const loginHandle = () => {
     if(phone === ""){
      ...
      axios.get(`https://isda-farm.onrender.com/login/${phone}`)
      .then((res) => {
    ...
    return(
        <>
        <div className="bg-gradient-to-t card_gradient card_gradient_m overflow-hidden h-screen relative ">
    ...
    <div className="h-screen w-full bg-[#00000069] flex-col flex justify-center items-center  absolute top-0 left-0">
      ...
      <Nav color={'#fff'} visibility={'block'} vl={'none'} wd={'200px'}/>
        ...
        <div className="w-[350px] h-[400px] border-[1px]  rounded-xl">
