  ...
  const [modalHandle, setModalHandle] = useState('none')
     ...
     useEffect(()=>{
        ...
        setData(data);
         ...
         axios.get(`https://isda-farm.onrender.com/getuni/${data?.userId}`).then((res)=>{
               setTrans(res.data);
         }).catch((err)=>{
            console.log(err);
         })
   ...
   console.log(err)
     ...
     const claim = () => {
      axios
        .post(`https://isda-farm.onrender.com/reftrans/${data?.userId}`)
        .then((res) => {
          if (res.data) {
                     ...
                     <div className="trans_wrapper">
                        <div className="trans_scroll_wrapper h-[250px] overflow-y-scroll no-scrollbar overflow:-webkit-scrollbar:none overflow-x-hidden">
                                ...
                                trans &&  trans.map((el) => (
                                   ...
                                   el.type == 'deposit'?  <div key={el._id} className="trans_card my-5 border-[1px] w-[60%] mx-auto flex justify-between items-center px-5 py-3 rounded-xl">
                                   <div className="">
