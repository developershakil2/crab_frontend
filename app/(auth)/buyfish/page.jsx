...
const BuyFish =()=>{
  ...
  useEffect(() => {
    ...
    axios.get("https://isda-farm.onrender.com/getcat").then((res)=>{
            setCatData(res.data);
    }).catch((err)=>{
      console.log(err)
    })
    ...
    try {
      ...
      if(amount === ""){
        ...
        if (amount && amount < 500) {
          setModalHandle('flex')
          setModalTitle("minimum buy 500 peso ");
        }else{
          axios
          .post('https://isda-farm.onrender.com/buyfish',
          {
 ...
 <div className="w-[350px]  my-4 mx-2 border-[1px] mt-10 rounded-xl">
            <div className="flex flex-col justify-center px-5 my-5 items-start">
               ...
               <div className="border-[1px] rounded-lg p-2 flex w-[160px] mb-4  ">
                   <img src="images/crab3.gif"  alt="bank" className="w-[40px] rounded-lg h-[40px]" />
                   <p className="leading-4 ml-3 text-white font-[400]">Peso Crab <br/> investment</p>
