...
const Signup =()=>{
  ...
  const [modalHandle, setModalHandle] = useState('none');
    ...
    const signupHandle = () => {
      ...
      axios.post("https://isda-farm.onrender.com/user", formData, {
        headers: {
    ...
    const sendCode = ()=>{
         ...
         axios.post("https://isda-farm.onrender.com/sendotp", `+1${phone}`).then((res)=>{
    ...
    axios.post("https://isda-farm.onrender.com/getCode",{phone:`+1${phone}`, code:code}).then((res)=>{
...
<div style={{display:modalHandle}} className="absolute bg-[#7e0beb69] z-50 top-0 left-0 w-full h-screen flex justify-center items-center">
        ...
        <div className="card_gradient card_gradient_m overflow-hidden h-screen relative ">
      ...
      </div>
    {
        ...
        <div className="w-[350px]   border-[1px] rounded-xl">
