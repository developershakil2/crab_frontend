...
const Dashboard =()=>{
    ...
    const [modalHandle, setModalHandle] = useState('none');
     ...
     useEffect(()=>{
        ...
        setData(data);
         ...
         axios.get(`https://isda-farm.onrender.com/purchasedata/${data?.userId}`).then((res)=>{
               setTrans(res.data.reverse());
         }).catch((err)=>{
            console.log(err);
         })
         axios.get(`https://isda-farm.onrender.com/login/${data.userphone}`).then((res)=>{
                     setRedata(res.data)
         }).catch((err)=>{
            console.log(err)
         })
        ...
        const [pId , setSinlgeId] = useState('')
         ...
         const claim = async ()=>{
            ...
            axios.post(`https://isda-farm.onrender.com/claim/${data?.userId}`, {pId}).then((res)=>{
    ...
    return(
        <>
        <div style={{display:modalHandle2}} className="absolute bg-[#7e0beb69] z-50 top-0 left-0 w-full h-screen flex justify-center items-center">
    ...
    <div style={{display:modalHandle}} className="absolute bg-[#000000bb] z-50 top-0 left-0 w-full h-screen flex justify-center items-center">
        ...
        <div className="card_gradient card_gradient_m overflow-x-hidden h-screen  relative ">
   ...
   <img src="images/crab3.gif" alt="fish"  className="w-[200px] h-[200px] fish6 absolute"/>
    ...
    <div className="w-[350px]  my-4 mx-2 border-[1px] rounded-xl">
    ...
    <div className="w-[350px] justify-center items-center my-2 mx-2  border-[1px] rounded-xl">
                <div className="flex flex-col justify-center px-5 my-5 items-start">
    ...
    <div className="w-[350px] justify-center items-center my-2 mx-2 border-[1px] rounded-xl">
                ...
                <a href="/buyfish" className="w-full mx-auto mb-2"> 
                 ...
                 <div className="p-1 w-[70px] mx-auto h-[70px] rounded-full border-[1px]">
                                    ...
                                    <img src="images/crab3.gif" alt="fish" className="w-[60px] h-[60px] rounded-full addIcon "/>
                                        </div>
                     ...
                     <div className="trans_wrapper">
                        <div className="trans_scroll_wrapper h-[250px] overflow-y-scroll no-scrollbar overflow:-webkit-scrollbar:none overflow-x-hidden">
                                ...
                                trans &&  trans.map((el) => (
                                   ...
                                   el.isWithdrawn == false?  <div key={el._id} className="trans_card my-5 border-[1px] w-[60%] mx-auto flex justify-between items-center px-5 py-3 rounded-xl">
                               ...
                               </div> :  <div key={el._id} className="trans_card my-5 border-[1px] w-[60%] mx-auto flex justify-between items-center px-5 py-3 rounded-xl">
                                   <div className="">
