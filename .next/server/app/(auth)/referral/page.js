...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7146)), "R:\\fish-farm\\crab_frontend-grayson\\app\\(auth)\\referral\\page.jsx"],
    ...
    const pages = ["R:\\fish-farm\\crab_frontend-grayson\\app\\(auth)\\referral\\page.jsx"];
...
const Referral = ()=>{
    ...
    const refLink = `https://pesocrab.com/register/?id=${data.userId}`;
    console.log(trans);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        const storedData = localStorage.getItem("usersOb");
        const data = JSON.parse(storedData);
        setData(data);
        axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z.get(`https://isda-farm.onrender.com/getuni/${data?.userId}`).then((res)=>{
            setTrans(res.data);
        }).catch((err)=>{
            console.log(err);
        });
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                        ...
                                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("input", {
                                            value: refLink,
                                            className: "text-center text-sm font-[600] bg-transparent px-2 text-white w-full h-[24px]  my-4"
                                        })
                                    }),
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`R:\fish-farm\crab_frontend-grayson\app\(auth)\referral\page.jsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [669,716,813,843], () => (__webpack_exec__(2841)));
